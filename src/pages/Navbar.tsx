...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-4 w-fit left-1/2 transform -translate-x-1/2 z-50">
      <div className="flex justify-between text-sm items-center w-[600px] h-[40px] px-10 overflow-auto gap-10 rounded-4xl bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl hover:bg-white/10 transition-all duration-300">
        <div>
          <div
            className={
